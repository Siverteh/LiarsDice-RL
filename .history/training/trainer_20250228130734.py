...
from agents.rule_agent import RandomAgent, ConservativeAgent, StrategicAgent, MildConservativeAgent, VeryMildConservativeAgent
...
class Trainer:
    ...
    def _create_opponent(self) -> BaseAgent:
        ...
        if self.config.opponent_type == "random":
            ...
            return VeryMildConservativeAgent(player_id=1, challenge_threshold=4)
